...
## SL library
SL.lib.stage1 <- c("SL.glm", "SL.glmnet", "SL.ranger", "SL.svm", "SL.ipredbagg", "SL.xgboost")

SL.lib.stage2.image <- c("SL.logOLS.smear", "SL.gammaLogGLM", "SL.gammaIdentityGLM", "SL.bayesglm",
                         "SL.gengamma", "SL.coxph", "SL.glmnet", "SL.rf.caret1",
                         "SL.ksvm", "SL.ipredbagg", "SL.xgboost")

SL.lib.stage.single.image <- c("SL.mean", "SL.lm", "SL.glmnet", "SL.zip", "SL.tweedie", "SL.tobit",
...
pred_single <- matrix(NA,nrow=nrow(train),ncol = 209)
  ...
  twostage.fit <- twostageSL.indicator(Y = train_temp$total_image_spine_RVU12mo, 
                                       X = train_temp[,-c(52:57)], 
                                       newX = test_temp[,-c(52:57)],
                                       library.2stage = list(stage1=SL.lib.stage1,
                                                             stage2=SL.lib.stage2.image),
                                       library.1stage = SL.lib.stage.single.image,
                                       twostage = TRUE,
                                       family.1 = binomial,
                                       family.2 = gaussian,
...
##################### Fit original two-stage Super Learner (no indicator) #######################
  ...
  getCoef.twostage <- method.CC_LS.scale()$computeCoef(Z = z.twostage, 
                                                       Y = train_temp$total_image_spine_RVU12mo,
...
# save output
# cvRisk
save(cvRisk_twostage_ind, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_cvRisk_two_stage_ind_seed=", parameter_grid$seed[iter],".RData"))

save(cvRisk_twostage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_cvRisk_two_stage_seed=", parameter_grid$seed[iter],".RData"))

save(cvRisk_onestage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_cvRisk_one_stage_seed=", parameter_grid$seed[iter],".RData"))


# Coef
save(coef_twostage_ind, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_coef_two_stage_ind_seed=", parameter_grid$seed[iter],".RData"))

save(coef_twostage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_coef_two_stage_seed=", parameter_grid$seed[iter],".RData"))

save(coef_onestage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_coef_one_stage_seed=", parameter_grid$seed[iter],".RData"))


# Data
save(pred_twostage_ind, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_twostage_ind_seed=", parameter_grid$seed[iter],".RData"))

save(pred_twostage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_twostage_seed=", parameter_grid$seed[iter],".RData"))

save(pred_onestage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_onestage_seed=", parameter_grid$seed[iter],".RData"))

save(pred_discrete_twostage, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_discrete_twostage_seed=", parameter_grid$seed[iter],".RData"))

save(pred_discrete_twostage_ind, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_discrete_twostage_ind_seed=", parameter_grid$seed[iter],".RData"))

save(pred_single, file=paste0("/projects/dbenkes/ziyue/sim_1/BOLD/image/results/image_pred_single_seed=", parameter_grid$seed[iter],".RData"))
